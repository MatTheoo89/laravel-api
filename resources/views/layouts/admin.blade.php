            ...
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
                    <div class="logo_laravel">
                        <img src="https://iili.io/45JHfn.png" alt="logo" style="width: 50px">
                    </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link text-white text-bold" href="{{url('/') }}">Public site</a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ route('admin.dashboard') }}">Administrator</a>
                                <a class="dropdown-item" href="{{ route('admin.projects.index') }}">List projects</a>
